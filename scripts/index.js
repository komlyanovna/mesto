...
const popupContentProfile = document.querySelector('.popup__form_profile')
...
const popupContentCard = document.querySelector('.popup__form_card');
...
const popupElementTemplate = document.querySelector('.popup__template');
