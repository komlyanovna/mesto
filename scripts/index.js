...
const popupContentProfile = document.querySelector('.popup__content-profile_form')
...
const popupContentCard = document.querySelector('.popup__content-card_form');
...
const popupElementTemplate = document.querySelector('.popup__element-template_image');
