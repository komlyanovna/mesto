...
const popupContentProfile = document.querySelector('.popup__content-profile')
...
const popupContentCard = document.querySelector('.popup__content-card');
...
const popupElementTemplate = document.querySelector('.popup__element_template');
