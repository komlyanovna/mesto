...
const popupElementTemplate = document.querySelector('.popup_content_image');
...
initialCards.forEach(function renderItem(item) {
  ...
  const elemTrash = templateElement.querySelector('.element__trash').addEventListener('click', function () {
    elementDiv.remove();
  });
